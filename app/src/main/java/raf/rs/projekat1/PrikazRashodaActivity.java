...
public class PrikazRashodaActivity extends AppCompatActivity {
    ...
    private void initPlayer() {
        ...
        if (intent.getExtras() != null) {
            ...
            if (rashod.getFile() != null) {
                play.setVisibility(View.VISIBLE);
                opis.setVisibility(View.GONE);
                mediaPlayer = MediaPlayer.create(this, Uri.fromFile(rashod.getFile()));
    ...
    private void initListener() {
        ...
        kolicina.setText(Integer.toString(rashod.getKolicina()));
        opis.setText(rashod.getOpis());
